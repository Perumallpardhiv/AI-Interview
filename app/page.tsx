    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            <span className="font-inter text-[#893DFF] font-bold md:text-[28px]" style={{ letterSpacing: '0.7px' }}>InterVueSense </span> <br />
            Redefining<br /> Interviews <span className="text-[#893DFF]">with AI</span>
            <span className="font-inter text-[#893DFF]">.</span>
          </motion.h1>
          ...
          >
            <div className="w-1/2">
              <h2 className="flex items-center font-semibold text-[0.8em] text-[#1a2b3b]">
                Platform
              </h2>
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              <Link
                href="/demo"
                className="group rounded-full px-4 py-2 text-[12px] font-semibold transition-all flex items-center justify-center bg-[#f5f7f9] text-[#1E2B3A] no-underline active:scale-95 scale-100 duration-75"
                style={{
